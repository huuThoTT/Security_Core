...
\begin{center}
    ...
    \Large \textbf{Thiết kế và Cài đặt Security Core Mức độ Cao cho \\ Hệ thống Ví điện tử SEC-Wallet} \\
    \vspace{0.3cm}
...
Chương trình Security Core của SEC-Wallet được thiết kế theo kiến trúc module, dựa trên nền tảng Mật mã đường cong Elliptic (ECC). Nhằm tối ưu hóa bảo mật và phục vụ đầy đủ 11 Use Case đặt ra từ các giai đoạn trước, hệ thống được cấu trúc thành **5 hàm cốt lõi (Core Functions)**. 
